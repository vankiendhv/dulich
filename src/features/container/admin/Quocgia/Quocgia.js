...
export class Quocgia extends Component {
    render() {
        return (
            <div id="admin">
                ...
                <div className="content">
                    <div className="add">
                        <Link to={`${this.props.url}/themquocgia`}><Button variant="outlined" color="secondary"><i className="fas fa-plus"></i>&nbsp;&nbsp; Thêm mới</Button></Link>
                    </div>
